...
import { IOrderDocument, IOrderModel } from './order.interface';
		...
		orderItems: [
			{
				...
				product: {
					type: Schema.Types.ObjectId, // Gets id of Product
					required: true,
...
const Order: IOrderModel = model<IOrderDocument, IOrderModel>('Order', orderSchema);
